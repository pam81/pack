$(document).ready(function() {
  $(".view_viajes").on("click", function() {
    ...
    $.ajax({
      ...
      .done(function(response) {
        ...
        $.each(response, function(i, item) {
          ...
          listado +=
            ...
            "</td>"
          listado +=
            "<td>" + item.art_valor + "</td><td>" + contado + "</td></tr>"
        })
      ...
      .fail(function() {
        swal({
          text: "error no se pudieron obtener los datos",
          icon: "warning"
        })
      })
  })
    ...
    $.ajax({
      ...
      .done(function(response) {
        ...
        $.each(response.ajustes, function(i, item) {
          ...
          ajustes +=
            "<tr><td>" + item.monto + "</td><td>" + item.descripcion + "</td>"
          ajustes +=
            "<td>" + type + "</td><td>" + item.created_by + "</td></tr>"
        })
  ...
  $("#saveCaja").on("click", function() {
    ...
    $.ajax({
      ...
      .fail(function() {
        swal({
          text: "No se ha podido agregar el movimiento de caja.",
          icon: "warning"
        })
        self.prop("disabled", false)
      })
