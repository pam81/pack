...
<div id="content">
  ...
  <form name="formbase" method="post" action="<?php echo site_url()."reserva/cancel/$nroreserva";?>" onsubmit=" if ( document.getElementById('motivo').value.length > 20) return true; else  { alert(messages.lengthminimo); return false;} ">
