...
<div id="content">
   ...
   <hr class="separador">
  <form name="formusuario" method="post" action="<?php  if ($abordo) { echo site_url()."viaje/update/".$this->uri->segment(3);} else {echo site_url()."viaje/abordo/".$this->uri->segment(3);} ?>">
