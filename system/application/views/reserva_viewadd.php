...
$(document).ready(function(){
  ...
  $("#telefono").change(function(){
    ...
    flete.getCliente('<?php echo site_url()."cliente/info/"?>','<?php echo site_url()."cliente/reservaadd/";?>','<?php echo $this->lang->line("title_add_cliente");?>');
...
<div id="content">
   ...
   <hr class="separador">
   <div id="left_reserva"> 
  <form name="formusuario" method="post" action="<?php echo site_url()."reserva/addnew";?>" onsubmit=" if (flete.validarReserva()) { document.getElementById('send').disabled=true;  return true;} else return false;">
   <?php echo validation_errors('<p class="error">','</p>'); ?>
  
  <?php $this->Flete_model->startPost();?>
    <div class="rowform">
   ...
   <input type="hidden" data-server="<?php echo site_url();?>" data-url="<?php echo site_url()."reserva/getClientReservas"?>"  name="clienteid" id="clienteid" value="<?php echo set_value("clienteid");?>"/>
    </div>
   </div>
   <div class="rowform">
  ...
  <div class="rowform-input">
   <input type="text" tabindex="9" readonly="true" id="name" name="name" value="<?php echo set_value("name");?>" maxlength="250"  />
   </div>
   </div>
   ...
   <div class="rowform-input">
   <textarea name="desde"  id="desde" tabindex="10"><?php echo set_value("desde");?></textarea>
   ...
   <div class="rowform-input">
   <textarea name="destino"  id="destino" tabindex="11"><?php echo set_value("destino");?></textarea>
   ...
   <input type="checkbox" id="hasMudanza" name="hasMudanza" value="1" tabindex="12" />
   ...
   <div class="rowform">
   <div class="rowform-label"> 
   <input type="checkbox" id="art" name="art" value="1" tabindex="12" />
   <label for="art"> <?php echo $this->lang->line("title_art"); ?>  </label>
   
   </div>
   <div class="rowform-input">
   <input type="text" tabindex="13" id="art_valor"  name="art_valor" value="<?php echo set_value("art_valor");?>" maxlength="250" />
   </div>
   </div>
   ...
   <div class="rowform-input">
   <input type="text" tabindex="14" id="presupuesto"  name="presupuesto" value="<?php echo set_value("presupuesto");?>" maxlength="250" />
   </div>
   </div>
   ...
   <div class="rowform-input">
   <textarea name="observacion" rows="3" cols="40" tabindex="15" rows="4" cols="15"><?php echo set_value("observacion");?></textarea>
   </div>
   </div>
    <!--
    <div class="rowform">
   ...
   <div class="rowform-input">
   <input type="text" tabindex="16" id="valor_mercaderia"  name="valor_mercaderia" value="<?php echo set_value("valor_mercaderia");?>" maxlength="250" />
   </div>
   </div>
  ...
  <div class="rowform">
   ...
   <div class="rowform-input">
   <input type="text" tabindex="17" id="excedente_mercaderia" onblur="flete.getExcedente('<?php echo site_url()."reserva/getExcedente";?>');"  name="excedente_mercaderia" value="<?php echo set_value("excedente_mercaderia");?>" maxlength="10" />
   </div>
   </div>
   ...
   <div class="rowform-input">
   <input type="text" tabindex="18" id="excedente_monto"  name="excedente_monto" value="<?php echo set_value("excedente_monto");?>" maxlength="10" />
   </div>
   </div>
   ...
   <div class="rowform-input">
   <input type="radio" tabindex="20" id="contado" checked="checked"  name="pago" value="1"   />
   </div>
   </div>
   ...
   <div class="rowform-input">
   <input type="radio" tabindex="21" id="ctacte"   name="pago" value="2" />
   </div>
   </div>
   <div class="rowform">
   <div class="rowform-label">
