   ...
   <tbody>
     ...
     $iva=0;
       ...
       <tr class="modotr">
         ...
         <td> <?php echo number_format($u["efvo"],2,".",''); $efvo += $u["efvo"];?> </td>
         ...
         <td> <?php echo number_format($u["peones"],2,".",''); $peones +=$u["peones"]; ?>  </td>
          ...
          <td> <?php echo number_format($u["estac"],2,".",''); $estacionamiento +=$u["estac"]; ?>  </td>
          <td> <?php echo number_format($u["otros"],2,".",''); $otros +=$u["otros"]; ?>  </td>
          <td> <?php echo number_format($u["seguro"],2,".",''); $seguro +=$u["seguro"]; ?>  </td>
           <td> <?php echo number_format($u["art"],2,".",''); $art +=$u["art"]; ?>  </td>
