...
<div id="content">
  ...
  <h2> <?php echo $this->lang->line("title_localidad");?></h2>
   ...
   <hr class="separador">
   <div id="left_reserva"> 
  <form name="formloc" id="formloc" method="post" action="<?php echo site_url()."localidad/addnew";?>">
   ...
   <input type="text" tabindex="2" id="name" name="name" value="" />
   
   </div> 

  <div class="rowform">
   <input type="submit" tabindex="2" id="send" accesskey="e" name="send" value="<?php echo $this->lang->line("button_send");?>" onclick="return confirm('<?php echo $this->lang->line("ask_add_localidad");?>'); "/>
