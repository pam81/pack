...
<div id="content">
  ...
  <h2> <?php echo $this->lang->line("nueva_bases");?></h2>
   ...
   <hr class="separador">
  <form name="formbase" id="formbase" method="post" action="<?php echo site_url()."base/addbase";?>">
  ...
  <div class="rowform">
   <input type="submit" tabindex="2" id="send" accesskey="e" name="send" value="<?php echo $this->lang->line("button_send");?>" onclick="return confirm('<?php echo $this->lang->line("ask_add_base");?>'); "/>
