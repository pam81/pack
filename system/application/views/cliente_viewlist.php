       ...
       <tr class="modotr <?php if ($u->borrado==1) echo "borrado";?>" >
         ...
         <td> <?php if ($u->active == 1) {?> 
          ...
          <td>
           ...
           <a class="desbloquea" data-url="<?php echo site_url()."cliente/unlock/$u->id/".$this->uri->segment(3);?>" onclick=" return confirm('<?php echo $this->lang->line("ask_debloquear_cliente");?>') ;" > <img src="<?php echo base_url()."images/img/lock.png";?>" width="16" height="16" alt="bloqueado" title="bloqueado por <?php echo $u->bloqueado_by;?>" /> </a>
           <?php }?>
          </td>
       </tr>
     <?php   }?>
